module.exports = Object.freeze({
  TOKEN: '1067010517:AAHVCqo3Crc9IWv_zO8ZUzN3wWGeBAfamMg',
  ARIA_SECRET: 'yua',
  ...
  GDRIVE_PARENT_DIR_ID: '1qVp74hhAwAbA7XZ6EXzHm4TrdtKcXckL',
  SUDO_USERS: [761714259],	// Telegram user IDs. These users can use the bot in any chat.
  AUTHORIZED_CHATS: [-1001486387452,-1001248473495],	// Telegram chat IDs. Anyone in these chats can use the bot.
